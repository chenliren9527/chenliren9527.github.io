---
title: Java基础加强(03)-多态、包、权限修饰符、内部类、Object类
tags:
  - 笔记
  - Java基础加强
  - 多态
...
![](多态、包、权限修饰符、内部类、Object类.assets/aaa.jpg)
...
![toString方法的自动重写](多态、包、权限修饰符、内部类、Object类.assets/toString方法的自动重写.bmp)
...
![](多态、包、权限修饰符、内部类、Object类.assets/equals方法1.png)

![](多态、包、权限修饰符、内部类、Object类.assets/equals方法2.png)

![](多态、包、权限修饰符、内部类、Object类.assets/equals方法3.png)
