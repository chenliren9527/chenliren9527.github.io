---
title: Java基础加强(07)-排序算法、二分查找、异常、线程的创建方式
tags:
  - 笔记
  - Java基础加强
  - 排序算法
...
![5](排序算法、二分查找、异常、线程的创建方式.assets/5.png)
...
![5](排序算法、二分查找、异常、线程的创建方式.assets/6.png)
...
![5](排序算法、二分查找、异常、线程的创建方式.assets/7.png)
...
![](排序算法、二分查找、异常、线程的创建方式.assets/异常体系.png)
...
![](排序算法、二分查找、异常、线程的创建方式.assets/简单的异常查看.bmp)
...
​    ![](排序算法、二分查找、异常、线程的创建方式.assets/异常的分类.png)
...
上述程序执行过程图解：
 ...
 ![](排序算法、二分查找、异常、线程的创建方式.assets/异常产生过程.png)
...
![](排序算法、二分查找、异常、线程的创建方式.assets/死了都要try.bmp)
...
![](排序算法、二分查找、异常、线程的创建方式.assets/并行与并发.bmp)
...
![](排序算法、二分查找、异常、线程的创建方式.assets/进程概念.png)

**线程**

![](排序算法、二分查找、异常、线程的创建方式.assets/线程概念.png)
...
- 抢占式调度
  ...
  ![抢占式调度](排序算法、二分查找、异常、线程的创建方式.assets/抢占式调度.bmp)
